...
import Logo from "../assets/sanjay_logo.png";
...
export default function Navbar() {
  ...
  const textColorClass =
    scrolled || !isHome ? "text-studio-white" : "text-white";
  const borderColorClass = scrolled
      ...
      >
        <div className="mx-auto max-w-[1400px] px-6 md:px-12 flex items-center justify-between">
          ...
          <Link to="/" className="relative z-50 group flex items-center gap-3">
            {/* Logo Container */}
            <div className="relative flex items-center justify-center w-[60px] h-[60px] rounded-full">
              {/* Spreaded Border Glow */}
              <div
              ...
              <div
                className="relative flex items-center justify-center w-full h-full rounded-full
                    bg-gray-400/10 backdrop-blur-sm"
              >
                <img
                  src={Logo}
